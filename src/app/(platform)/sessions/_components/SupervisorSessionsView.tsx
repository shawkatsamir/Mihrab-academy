...
export function SupervisorSessionsView({ sessions }: Props) {
  const [shiftSession, setShiftSession] = useState<SessionDetailRow | null>(
    null,
  );
  const [cancelSession, setCancelSession] = useState<SessionDetailRow | null>(
    null,
  );
